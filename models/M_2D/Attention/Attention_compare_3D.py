...
class Attention_3D_unique(nn.Module):
    def __init__(self,
        ...
        self.dsa = max(img_size[0], (self.img_size[0]*self.img_size[1]*self.img_size[2]) // reduction_sa_Attention)
    ...
    def forward(self, x_input):
        ...
        if self.sa_flag==True:
            ...
            sa_out_fc = self.sigmoid(self.fc2(sa_out.view(b, w * h * l)))

            weights_sa = []
            for fsa in self.fsas:
                weight_s = self.sigmoid(fsa(sa_out_fc))
