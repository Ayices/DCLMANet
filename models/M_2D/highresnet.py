...
from module.Highresnet_Module_2D import DilationBlock, ConvolutionalBlock
...
if __name__ == '__main__':
    ...
    img = torch.randn(2, 4, 64, 64).cuda()
    net = HighRes2DNet(in_channels=4, out_channels=5).cuda()
    out = net(img)
    print(out.shape)
