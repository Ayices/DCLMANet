import torch
from module.unet_utils import up_block, down_block
from module.conv_trans_utils import *
...
###########################################################################
    ...
    img = torch.randn(2, 4, 128, 128).cuda()
    net = UTNet(in_chan=4, base_chan=16, num_classes=5).cuda()
    out = net(img)
    print(out.shape)
