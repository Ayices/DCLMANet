...
class Neuron_SegNet(Module):
    ...
    """
    def __init__(self, in_channels=1, num_class = 2, with_BN = True, channel_width = 4):
...
class Neuron_WaveSNet_V1(Module):
    ...
    """
    def __init__(self, in_channels=1, num_class = 2, with_BN = True, channel_width = 4, wavename = 'haar'):
...
if __name__ == '__main__':
    ...
    它的编解码器两端进行下采样和上采样分别使用 max-pooling 和 max-unpooling
    """
    input = torch.rand(size=(2, 4, 64, 64, 64)).float().cuda()
    model = Neuron_SegNet(in_channels=4, num_class=4, channel_width=8).cuda()
    print('====================================')
    start = datetime.now()
    output = model(input)
    print('Neuron_SegNet')
    ...
    """
    input = torch.rand(size=(2, 4, 64, 64, 64)).float().cuda()
    model = Neuron_UNet_V1(in_channels=4, num_class=4, channel_width=8).cuda()
    print('====================================')
    start = datetime.now()
    output = model(input)
    print('Neuron_UNet_V1')
    print(output.size())
    stop = datetime.now()
    print('tooking {} secs'.format(stop - start))
    print('====================================')
    ...
    """
    input = torch.rand(size=(2, 4, 64, 64, 64)).float().cuda()
    model = Neuron_UNet_V2(in_channels=4, num_class=4, channel_width=8).cuda()
    print('====================================')
    start = datetime.now()
    output = model(input)
    print('Neuron_UNet_V2')
    print(output.size())
    stop = datetime.now()
    print('tooking {} secs'.format(stop - start))
    print('====================================')
    ...
    """
    input = torch.rand(size=(2, 4, 64, 64, 64)).float().cuda()
    model = Neuron_WaveSNet_V1(in_channels=4, num_class=4, channel_width=8).cuda()
    print('====================================')
    start = datetime.now()
    output = model(input)
    print('Neuron_WaveSNet_V1')
    print(output.size())
    stop = datetime.now()
    print('tooking {} secs'.format(stop - start))
    print('====================================')
    ...
    """
    input = torch.rand(size=(2, 4, 64, 64, 64)).float().cuda()
    model = Neuron_WaveSNet_V2(in_channels=4, num_class=4, channel_width=8).cuda()
    print('====================================')
    start = datetime.now()
    output = model(input)
    print('Neuron_WaveSNet_V2')
    print(output.size())
    stop = datetime.now()
    print('tooking {} secs'.format(stop - start))
    print('====================================')
    ...
    """
    input = torch.rand(size=(2, 4, 64, 64, 64)).float().cuda()
    model = Neuron_WaveSNet_V3(in_channels=4, num_class=4, channel_width=8).cuda()
    print('====================================')
    start = datetime.now()
    output = model(input)
    print('Neuron_WaveSNet_V3')
    print(output.size())
    stop = datetime.now()
    print('tooking {} secs'.format(stop - start))
    print('====================================')
    ...
    """
    input = torch.rand(size=(2, 4, 64, 64, 64)).float().cuda()
    model = Neuron_WaveSNet_V4(in_channels=4, num_class=4, channel_width=8).cuda()
    print('====================================')
    start = datetime.now()
    output = model(input)
