...
from .module.Highresnet_Module_3D import ConvolutionalBlock, DilationBlock
...
class HighResNet(nn.Module):
    ...
    def forward(self, x):
        return self.Softmax_layer(self.block(x))
...
if __name__ == '__main__':
    ...
    img = torch.randn(2, 4, 64, 64, 64).cuda()
    net = HighRes3DNet(in_channels=4, out_channels=5).cuda()
    out = net(img)
    print(out.shape)
    # print(out[1].shape)
    # print(out[2].shape)
