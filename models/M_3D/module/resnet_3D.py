...
class BasicBlock_os(nn.Module):
    expansion = 1

    def __init__(self, in_channels, channels, stride=1, dilation=1):
        super(BasicBlock_os, self).__init__()
...
class Bottleneck_os(nn.Module):
    expansion = 4

    def __init__(self, in_channels, channels, stride=1, dilation=1):
        super(Bottleneck_os, self).__init__()
...
class ResNet_Bottleneck_OS16(nn.Module):
    def __init__(self, num_layers, input_channels):
        ...
        self.layer5 = make_layer(Bottleneck_os, in_channels=4*256, channels=512, num_blocks=3, stride=1, dilation=2)
...
class ResNet_BasicBlock_OS16(nn.Module):
    def __init__(self, num_layers, input_channels):
        ...
        self.layer5 = make_layer(BasicBlock_os, in_channels=256, channels=512, num_blocks=num_blocks, stride=1, dilation=2)
...
class ResNet_BasicBlock_OS8(nn.Module):
    def __init__(self, num_layers, input_channels):
        ...
        self.layer4 = make_layer(BasicBlock_os, in_channels=128, channels=256, num_blocks=num_blocks_layer_4, stride=1, dilation=2)

        self.layer5 = make_layer(BasicBlock_os, in_channels=256, channels=512, num_blocks=num_blocks_layer_5, stride=1, dilation=4)
