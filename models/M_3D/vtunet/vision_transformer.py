...
class VTUNet(nn.Module):
    def __init__(self, config, num_classes=4, zero_head=False, embed_dim=96, win_size=7):
    ...
    def load_from(self, config):
        pretrained_path = "/home/huxubin/MRISegmentation/models/M_3D/vtunet/swin_tiny_patch4_window7_224.pth"
